...
async function main() {
  ...
  const maxTokens = BigInt(auth.graduationLiquidity.maxLiquidityTokens); const quoteRaw = nativeQuote ? BigInt(auth.graduationLiquidity.maxLiquidityLamports) : BigInt(auth.quote.expectedQuoteAmount);
