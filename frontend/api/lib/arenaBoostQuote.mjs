...
export function readBoostPricingConfig(chainId, env = process.env) {
  ...
  if (!nativeUsdRaw || !pricingVersionRaw || !treasuryAddress || !signerKey) {
  ...
  return { chainId: chain, nativeUsdMicros, pricingVersion, treasuryAddress, signer };
}
