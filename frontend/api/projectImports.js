...
function errorStatus(code) {
  ...
  if (String(code).startsWith("PROJECT_IMPORT_EVIDENCE") || ["PROJECT_IMPORT_SIGNED_CLAIM_REQUIRED","PROJECT_IMPORT_TECHNICAL_REVIEW","PROJECT_IMPORT_REVIEW_PROOF_REQUIRED","PROJECT_IMPORT_STILL_BONDING","PROJECT_IMPORT_REVIEW_REQUIRED"].includes(code)) return 409;
