...
export function projectImportFeedback(error) {
  ...
  if (isWalletSignFailure(error)) return { title: 'WALLET COULD NOT SIGN', message: 'The connected wallet failed to sign this import check. Approve the Phantom popup. If none appears, reconnect Phantom and press IMPORT again.', retry: true };
