...
test("Robinhood 46630 staging env pins GREEN deployment identities", () => {
  ...
  assertEnvLine("VOTE_TREASURY_ADDRESS_46630=0x670256a51020477e4E96d7D7a94ac1783F1B1789");
  assertEnvLine("CREATOR_REWARDS_VAULT_ADDRESS_46630=0x57C2e716F1898D4818FEc3990e03E9997cE9052C");
  assertEnvLine("REWARD_DISTRIBUTOR_ADDRESS_46630=0x249233556aB4B42d860669AA8C9d5fedc51b8D3b");
