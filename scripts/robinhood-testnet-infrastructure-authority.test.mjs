...
function receipt(address, blockNumber) { return { address, txHash: TX, blockNumber, runtimeCodeHash: H }; }
function manifestInput() {
  return {
    chainId: 46630,
    sourceSha: "eb3a73acd0603259803f500d010731220e9b852c",
    deployer: A,
    oracleUpdater: F,
    feeTier: 3000,
    feeTickSpacing: 60,
    deployments: {
      weth: receipt(B, 10), v3Factory: receipt(C, 11), positionManager: receipt(D, 14), swapRouter02: receipt(E, 15), oracle: receipt(F, 16),
    },
    peripheryDependencies: { nftDescriptor: receipt(G, 12), tokenDescriptor: receipt(I, 13) },
